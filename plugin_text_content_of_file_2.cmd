...
::-----------------------------------------------------------------------------
::  plugin_text_content_of_file_2.cmd                                10/02/2016
::-----------------------------------------------------------------------------
::  Description  :  Add the content of a text file.
::               :  and add the c: usage and the result of cal.exe utility
...
:: Displays a Calendar on the terminal... that we redirect to a file
@SET "CAL=..\bin\cal\cal.exe"
:: Calendar options
@SET CALENDAR_OPTIONS=-1 -m
...
@%CAL% %CALENDAR_OPTIONS% >> !FICH_TXT_TMP!
@echo !LINEA! >> !FICH_TXT_TMP!
